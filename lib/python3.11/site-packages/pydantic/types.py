...
class Tag:
    ...
    !!! note
        ...
        [`callable-discriminator-no-tag`](.src/errors/usage_errors.md#callable-discriminator-no-tag).

    See the [Discriminated Unions] concepts docs for more details on how to use `Tag`s.

    [Discriminated Unions]: .src/concepts/unions.md#discriminated-unions
    """
...
class Discriminator:
    ...
    """Type to use in [custom errors](.src/errors/errors.md#custom-errors) replacing the standard discriminated union
    validation errors.
    """
