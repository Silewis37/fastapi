...
def field_validator(
    ...
    *fields: str,
    ...
    For more in depth examples, see [Field Validators](.src/concepts/validators.md#field-validators).
...
def model_validator(
    *,
    ...
    For more in depth examples, see [Model Validators](.src/concepts/validators.md#model-validators).
