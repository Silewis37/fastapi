...
class ConfigDict(TypedDict, total=False):
    ...
    * `ignore` - Ignore any extra attributes.
    ...
    See [Strict Mode](.src/concepts/strict_mode.md) for more details.

    See the [Conversion Table](.src/concepts/conversion_table.md) for more details on how Pydantic converts data in both
    ...
    See [Pydantic Plugins](.src/concepts/plugins.md) for details.
    """
