...
def foragingLVL():
    with open("src/skillsDAT/Foraginglvlreq.json") as file:
        ...
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_foraging"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
...
def miningLVL():
    with open("src/skillsDAT/Mininglvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_mining"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def farmingLVL():
    with open("src/skillsDAT/Farminglvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_farming"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def combatLVL():
    with open("src/skillsDAT/Combatlvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_combat"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def fishingLVL():
    with open("src/skillsDAT/Fishinglvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_fishing"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def enchantingLVL():
    with open("src/skillsDAT/Enchantinglvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_enchanting"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def alchemyLVL():
    with open("src/skillsDAT/Alchemylvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_alchemy"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def carpentryLVL():
    with open("src/skillsDAT/Carpentrylvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_carpentry"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def runecraftingLVL():
    with open("src/skillsDAT/Runecraftinglvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_runecrafting"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def socialLVL():
    with open("src/skillsDAT/Sociallvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_social2"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
...
def tamingLVL():
    with open("src/skillsDAT/Taminglvlreq.json") as file:
        exp_values = json.load(file)
        player_exp = prodat["profile"]["members"]["c3ca1ae1236c45d5922f2b1ec7eca271"]["experience_skill_taming"]
        found_level = "Level 0"
        percent_to_next = 0
        exp_to_next = 0
        overflow_exp_v = False
